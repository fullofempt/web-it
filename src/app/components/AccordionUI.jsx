...
const AccordionUI = ({title, children, Id, Index, setIndex}) => {
  ...
  return (
    ...
    <div
      ...
      className="flex group cursor-pointer w-3/4 mx-auto h-16 justify-between  items-center p-2 mt-2 rounded-md bg-blue-200 hover:bg-pink-500 hover:shadow-lg focus:bg-piёnk-500 "
    >
